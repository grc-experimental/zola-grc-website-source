...
## I. A Concrete Discomfort: Where Regress Quietly Appears

- Begin with a familiar definition (e.g. *structure*, *model*, or *category*).
- Observe the use of terms like:
  - “collection”
  - “consists of”
  - “object”
  - “map”
- Note that these terms are not defined within the theory being discussed.
- Emphasize that mathematics proceeds smoothly anyway.
- Do **not** yet name the regress; let it be felt.
